package com.pashkobohdan.spritzreaderpro.application.ui.dialog;
...
import com.pashkobohdan.spritzreaderpro.application.utils.NullUtils;
...
import com.pashkobohdan.spritzreaderpro.application.utils.ui.LabelUtils;
        ...
        if (validationResult != ValidationResult.Ok) {
            ...
            if (bookDTO == null) {
                bookDTO = new BookDTO(nameEditText.getText().toString(), authorEditText.getText().toString(),
                        textEditText.getText().toString(), null, 0, null, null);
            } else {
